...
TEST_DATA = [
    ...
    ("estou feliz com essa conquista", "alegria"),
    ("que noticia maravilhosa para todos", "alegria"),
    ("hoje acordei muito animado", "alegria"),
    ("esse resultado me deixou contente", "alegria"),
    ("nosso encontro foi cheio de amor", "alegria"),
]
